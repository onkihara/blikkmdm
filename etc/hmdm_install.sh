...
CLIENT_VERSION=5.01
DEFAULT_HMDM_LANGUAGE=$HMDM_LANGUAGE
DEFAULT_SQL_HOST=$HMDM_SQL_HOST
DEFAULT_SQL_PORT=$HMDM_SQL_PORT
DEFAULT_SQL_BASE=$HMDM_SQL_BASE
DEFAULT_SQL_USER=$HMDM_SQL_USER
DEFAULT_SQL_PASS=$HMDM_SQL_PASS
...
TOMCAT_HOST=$HMDM_TOMCAT_HOST
DEFAULT_PROTOCOL=$HMDM_TOMCAT_PORTOCOL
DEFAULT_BASE_DOMAIN=$HMDM_TOMCAT_DOMAIN
DEFAULT_BASE_PATH="ROOT"
DEFAULT_PORT=$HMDM_TOMCAT_PORT
DEFAULT_EXTERNPORT=$HMDM_TOMCAT_EXTERNPORT
TEMP_DIRECTORY="/tmp"
